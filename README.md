...
30 years from Amiga TTS to spatial computing · tiny super-optimized code with a flair for fractal compression

available for architecture, prototyping & research · [aĩr.com](https://aĩr.com)

**currently building**

🧘 tiny fast full-duplex emotional speech that runs on a mobile; distributed compute and cloud mesh

🪐 spatial radio mesh interactive AI music gen, synth & code agents flow studio

🫧 water droplet tiny gravity light reservoir compute
